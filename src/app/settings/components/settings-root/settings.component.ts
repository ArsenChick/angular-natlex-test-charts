...
export class SettingsComponent {
  ...
  public charts$ = this.store.select(selectCharts);
  ...
  public onEdit({ id, settings }: Chart): void {
  ...
  private openDialog<T, P>(
    dialogComponent: ComponentType<T>, dialogData?: P
  ): MatDialogRef<T, any> {
